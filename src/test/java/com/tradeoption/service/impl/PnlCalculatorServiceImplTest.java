...
public class PnlCalculatorServiceImplTest {
    ...
    public void testLongCallPnl() {
        ...
        OptionLeg longCall = new OptionLeg(100.0, LegType.CE, TradeAction.BUY, 5.0, 1);
    ...
    public void testShortPutPnl() {
        ...
        OptionLeg shortPut = new OptionLeg(100.0, LegType.PE, TradeAction.SELL, 5.0, 1);
    ...
    public void testStraddlePnl() {
        ...
        straddle.addLeg(new OptionLeg(100.0, LegType.CE, TradeAction.BUY, 5.0, 1));
        straddle.addLeg(new OptionLeg(100.0, LegType.PE, TradeAction.BUY, 5.0, 1));
