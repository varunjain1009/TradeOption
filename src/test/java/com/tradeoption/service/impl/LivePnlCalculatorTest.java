...
public class LivePnlCalculatorTest {
    ...
    public void testCalculateLiveStrategyPnl_LongCall() {
        ...
        OptionLeg leg = new OptionLeg(10000, LegType.CE, TradeAction.BUY, 50, 100, "28MAR2024", "NIFTY");
        strategy.addLeg(leg);
    ...
    public void testCalculateLiveStrategyPnl_ShortPut() {
        ...
        OptionLeg leg = new OptionLeg(10000, LegType.PE, TradeAction.SELL, 40, 100, "28MAR2024", "NIFTY");
        strategy.addLeg(leg);
    ...
    public void testCalculateLiveStrategyPnl_MultiLeg() {
        ...
        OptionLeg longLeg = new OptionLeg(10000, LegType.CE, TradeAction.BUY, 50, 100, "28MAR2024", "NIFTY");
        // Short Call 10200 CE @ 20
        OptionLeg shortLeg = new OptionLeg(10200, LegType.CE, TradeAction.SELL, 20, 100, "28MAR2024", "NIFTY");
