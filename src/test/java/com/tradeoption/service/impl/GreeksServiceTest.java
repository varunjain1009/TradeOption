...
public class GreeksServiceTest {
    ...
    public void testStrategyAggregation_DeltaNeutral() {
        ...
        OptionLeg callLeg = new OptionLeg(10000, LegType.CE, TradeAction.BUY, 0, 100); // 1 lot = 100 qty
        ...
        OptionLeg buyCall = new OptionLeg(10000, LegType.CE, TradeAction.BUY, 0, 100);
        OptionLeg sellCall = new OptionLeg(10000, LegType.CE, TradeAction.SELL, 0, 100);
        ...
        OptionLeg leg1 = new OptionLeg(100, LegType.CE, TradeAction.BUY, 0, 1);
        OptionLeg leg2 = new OptionLeg(100, LegType.CE, TradeAction.SELL, 0, 1);
